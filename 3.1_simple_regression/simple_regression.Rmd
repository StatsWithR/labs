...
<div class="question">
 Plot the relationship between `runs` and `at_bats`, using `at_bats` as the explanatory variable. <br> The relationship appears to be ...
...
<div class="exercise">
If you knew a team's `at_bats`, would you be comfortable using 
...
<div class="exercise">
Using `plot_ss`, choose a line that does a good job of minimizing 
...
<div class="exercise">
If a team manager saw the least squares regression line and 
...
<div class="question"> Which of the following is true? 
...
<div class="question"> Based on the residuals plot from earlier, the constant variability condition appears to be met. 
...
<div class="exercise">
Check the model diagnostics for the regression model with the 
